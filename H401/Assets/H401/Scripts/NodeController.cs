...
public class NodeController : MonoBehaviour {
    ...
    [SerializeField]
    private NodeTemplate[] NodeTemp = 
        {
        new NodeTemplate("Materials/hex0"),
        new NodeTemplate("Materials/hex1"),
        new NodeTemplate("Materials/hex2"),
        new NodeTemplate("Materials/hex3"),
        new NodeTemplate("Materials/hex4"),
        new NodeTemplate("Materials/hex5"),
        new NodeTemplate("Materials/hex6"),
        new NodeTemplate("Materials/hex7"),
    };
