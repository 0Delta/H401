...
public class ScoreManager : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject AWSObj = Instantiate(Resources.Load("AWSPrefab")) as GameObject;
        AWSObj.name = "AWS";
        ...
        Load();
        // ファイルからスコア読み出し
        SListInstance.Insert((int)(Random.value*1000));
        Save();
        Debug.Log(SListInstance.ToString());
        Disp();
    }
    ...
    public void Send()
    {
        AWS.Add(SListInstance[0].Score, NameEntryField.text);
    }
